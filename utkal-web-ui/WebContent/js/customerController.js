...
function saveCustomer(jsonData){
	...
	$.ajax({
		 ...
		 type: 'POST',
	     url : 'http://localhost:8082/api/customer/saveCustomer',
	     data : jsonData,
...
function validateCustomerForm(){
	...
	'"customerType":"Regular","securityDeposit":"'+$("#securityDeposit").val()+'",'+
...
function getCustomerById(){
	...
	$.ajax({
		 ...
		 type: 'GET',
	     url : 'http://localhost:8082/api/customer/customerById/'+customerId,
	     crossdomain: true,
	     beforeSend : function(){},
	     complete: function() {
	    },
